...
import getQueuesFromUser from '@salesforce/apex/QueueFetchFromUser.getQueueFromUser';
import getQueuesAll from '@salesforce/apex/QueueFetchFromUser.getQueueFromAll';
import getPublicGroupFromUser from '@salesforce/apex/QueueFetchFromUser.getPublicGroupFromUser';
import getPublicGroupAll from '@salesforce/apex/QueueFetchFromUser.getPublicGroupFromAll';
import updateUser from '@salesforce/apex/QueueFetchFromUser.updateUser';
import insertQueueForUser from '@salesforce/apex/QueueFetchFromUser.insertQueueForUser';
import getProfilesAll from '@salesforce/apex/QueueFetchFromUser.getProfiles';
import getAllPS from '@salesforce/apex/QueueFetchFromUser.getAllPS';
import getPS from '@salesforce/apex/QueueFetchFromUser.getPS';
import insertPermissionSetAssignment from '@salesforce/apex/QueueFetchFromUser.insertPermissionSetAssignment';
import {ShowToastEvent} from "lightning/platformShowToastEvent";
import LightningAlert from 'lightning/alert';

export default class NnioUserModalForm extends LightningModal {
    @api content;
   // @api options=[];
